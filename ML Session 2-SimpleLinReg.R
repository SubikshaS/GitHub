setwd("C:/Users/Subiksha/Desktop/SEMESTER III/ML")
getwd()
...
#It indicates a negative linear relationshipbtw 2 variables
...
plot(cars_data$Age_06_15, cars_data$Price, xlab = "Age of the car", ylab = "Price in ($)", pch = 12, col = "blue")

cor(cars_data)
cor(cars_data$Age_06_15, cars_data$Price)
#The correlation coefficient of the age of the car and price is -0.08765905
...
#Confidence Intervals talks about the average values intervals
#Prediction Intervals talks about theall individual values intervals
...
points(cars_test$Age_06_15, Conf_Pred$upr, pch = "-", col = "blue", lwd = 4)
